...
VALUES
    ...
    ('discoveryClient', NULL, '{bcrypt}$2a$10$4zKKibXgkN9RbR8oKaaNvu8xP7WalNoqnBWLKALdLkB7.IxuN34.i', 'read,write', 'implicit,authorize_code,refresh_token,password', NULL, 'ROLE_ADMIN', NULL, NULL, NULL, 'read,write');
# 用户
